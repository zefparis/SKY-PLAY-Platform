  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-[#00165F]/40 rounded-2xl border dark:border-white/10 border-[#00165F]/10 overflow-hidden">
        <div className="px-6 py-4 border-b dark:border-white/10 border-[#00165F]/10">
          <h3 className="text-lg font-bold dark:text-white text-[#00165F]">Transactions récentes</h3>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-[#00165F]/20 dark:bg-[#00165F]/60">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-bold dark:text-white/60 text-[#00165F]/60 uppercase">Montant</th>
            ...
            <tbody className="divide-y dark:divide-white/10 divide-[#00165F]/10">
              {transactions.map((tx) => (
                <tr key={tx.id} className="dark:hover:bg-white/5 hover:bg-[#00165F]/5 transition">
                  ...
                  <td className="px-6 py-4"><AdminBadge status={tx.type} variant="info" /></td>
                  <td className="px-6 py-4 text-sm font-bold dark:text-white text-[#00165F]">
