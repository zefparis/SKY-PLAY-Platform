      ...
      <main className="pb-12">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            ...
            <p className="text-white/65">Top players on SKY PLAY</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <Card className="text-center">
            ...
            <p className="text-white/65 mb-4">Top Player</p>
          ...
          <Card className="text-center">
            ...
            <p className="text-white/65 mb-4">Highest Earnings</p>
          ...
          <Card className="text-center">
            ...
            <p className="text-white/65 mb-4">Active Players</p>
