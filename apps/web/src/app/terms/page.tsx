...
export const metadata: Metadata = {
  title: "Conditions d'Utilisation — SKYPLAY AFRICA",
  description:
...
const SECTIONS: { title: string; paragraphs: string[] }[] = [
  {
    ...
    paragraphs: [
      "SKYPLAY AFRICA (\"SKYPLAY AFRICA\", \"nous\", \"la plateforme\") est une plateforme de compétitions gaming en ligne accessible à l'adresse skyplay.cloud et via ses applications mobiles.",
      "Le service permet aux utilisateurs de : participer à des défis (challenges) 1v1 ou multijoueurs avec mise en jeu de Sky Credits, s'inscrire à des tournois organisés par SKYPLAY AFRICA ou par d'autres utilisateurs, diffuser en direct leurs matchs via l'intégration YouTube, rejoindre des ligues compétitives avec classements et saisons, gérer un portefeuille numérique (Sky Credits) avec dépôts et retraits.",
      "SKYPLAY AFRICA est un service de divertissement compétitif basé sur l'habileté des joueurs. Il ne s'agit en aucun cas d'un service de jeux de hasard ou de paris en ligne.",
    ],
  },
  {
    title: '2. Éligibilité',
    paragraphs: [
      "Pour utiliser SKYPLAY AFRICA, vous devez : être âgé de 18 ans ou plus, ou être âgé de 16 à 18 ans avec l'autorisation écrite et vérifiable de votre représentant légal.",
      ...
      "SKYPLAY AFRICA se réserve le droit de demander une vérification d'identité à tout moment et de suspendre tout compte ne répondant pas aux critères d'éligibilité.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "Chaque personne ne peut détenir qu'un seul compte SKYPLAY AFRICA. La création de comptes multiples (multi-accounting) est strictement interdite et entraîne la suspension immédiate de tous les comptes concernés.",
  ...
  },
  {
    ...
    paragraphs: [
      "Les compétitions sur SKYPLAY AFRICA sont régies par des règles spécifiques à chaque jeu et format. En participant, vous acceptez de respecter ces règles.",
      ...
      "Litiges — En cas de désaccord sur un résultat, un système de contestation (dispute) est disponible. Les litiges sont examinés par l'équipe d'administration de SKYPLAY AFRICA, dont la décision est définitive.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Frais — SKYPLAY AFRICA prélève une commission sur les mises des compétitions. Le taux de commission est clairement affiché avant chaque engagement.",
      ...
      "SKYPLAY AFRICA se réserve le droit de geler ou saisir les Sky Credits d'un compte en cas de fraude avérée, conformément à la section 6.",
    ],
  },
  {
    title: '6. Comportement interdit',
    paragraphs: [
      "Les comportements suivants sont strictement interdits sur SKYPLAY AFRICA et peuvent entraîner des sanctions allant de l'avertissement à la suppression définitive du compte avec confiscation des Sky Credits :",
      ...
      "Les décisions de modération sont prises par l'équipe SKYPLAY AFRICA après examen des preuves. L'utilisateur sanctionné peut contester la décision en contactant l'adresse indiquée en section 11.",
    ],
  },
  {
    title: '7. Streaming et contenu',
    paragraphs: [
      "SKYPLAY AFRICA permet aux utilisateurs de diffuser leurs matchs en direct via l'intégration YouTube. En utilisant cette fonctionnalité, vous vous engagez à respecter les conditions d'utilisation de YouTube et les règles de la communauté Google.",
      "Vous êtes seul responsable du contenu diffusé via votre chaîne YouTube. SKYPLAY AFRICA ne peut être tenu responsable des contenus créés ou diffusés par les utilisateurs.",
      "SKYPLAY AFRICA se réserve le droit de désactiver la fonctionnalité de streaming pour tout utilisateur ne respectant pas les présentes conditions.",
    ],
  },
  {
    title: '8. Propriété intellectuelle',
    paragraphs: [
      "L'ensemble des éléments constituant la plateforme SKYPLAY AFRICA (design, code source, logo, marques, textes, images) sont la propriété exclusive de SKYPLAY AFRICA ou de ses concédants de licence.",
  ...
  },
  {
    ...
    paragraphs: [
      "SKYPLAY AFRICA est fourni \"en l'état\". Nous nous efforçons d'assurer la disponibilité et le bon fonctionnement de la plateforme, mais ne garantissons pas un service exempt d'interruptions ou d'erreurs.",
      "SKYPLAY AFRICA ne peut être tenu responsable de : pertes financières résultant de la participation aux compétitions, problèmes techniques liés à votre connexion internet ou à votre équipement, contenus publiés par les utilisateurs, dysfonctionnements de services tiers (YouTube, Steam, Flutterwave, etc.).",
      "La responsabilité totale de SKYPLAY AFRICA envers un utilisateur est limitée au montant des Sky Credits détenus sur son compte au moment du litige.",
    ],
  },
  {
    title: '10. Suspension et résiliation',
    paragraphs: [
      "SKYPLAY AFRICA se réserve le droit de suspendre ou résilier votre compte à tout moment en cas de violation des présentes conditions, sans préavis pour les cas de fraude ou de triche.",
  ...
  },
  {
    ...
    paragraphs: [
      "SKYPLAY AFRICA se réserve le droit de modifier les présentes conditions à tout moment. Toute modification substantielle sera notifiée par e-mail ou par notification dans l'application au moins 15 jours avant son entrée en vigueur.",
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="bg-[#111630] rounded-2xl border border-white/10 p-6 mb-6">
          <p className="text-white/70 text-sm leading-relaxed">
            Bienvenue sur SKYPLAY AFRICA. En créant un compte ou en utilisant nos
