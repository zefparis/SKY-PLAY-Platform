  ...
  return (
    <Card variant="glass">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-black bg-gradient-to-r from-[#0097FC] to-[#003399] bg-clip-text text-transparent">INFORMATIONS PERSONNELLES</h2>
        {!isEditing && (
          <Button
            variant="secondary"
            size="sm"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Username */}
        <div className="group">
          <label className="block text-xs font-bold uppercase tracking-wider dark:text-white/40 text-[#00165F]/40 mb-2">Username</label>
          {isEditing ? (
            <input
              type="text"
        ...
        {/* Prénom */}
        <div className="group">
          <label className="block text-xs font-bold uppercase tracking-wider dark:text-white/40 text-[#00165F]/40 mb-2">Prénom</label>
          {isEditing ? (
            <input
              type="text"
            ...
            <div className="px-4 py-3 dark:bg-white/5 bg-[#00165F]/5 rounded-xl border dark:border-white/10 border-[#00165F]/10">
              <p className="dark:text-white text-[#00165F] font-semibold">{formData.firstName || <span className="dark:text-white/40 text-[#00165F]/40">Non renseigné</span>}</p>
            </div>
          )}
        </div>
        ...
        {/* Nom */}
        <div className="group">
          <label className="block text-xs font-bold uppercase tracking-wider dark:text-white/40 text-[#00165F]/40 mb-2">Nom</label>
          {isEditing ? (
            <input
              type="text"
            ...
            <div className="px-4 py-3 dark:bg-white/5 bg-[#00165F]/5 rounded-xl border dark:border-white/10 border-[#00165F]/10">
              <p className="dark:text-white text-[#00165F] font-semibold">{formData.lastName || <span className="dark:text-white/40 text-[#00165F]/40">Non renseigné</span>}</p>
            </div>
          )}
        </div>
        ...
        <div className="md:col-span-2 group">
          <label className="block text-xs font-bold uppercase tracking-wider dark:text-white/40 text-[#00165F]/40 mb-2">Bio</label>
          {isEditing ? (
            <textarea
              value={formData.bio || ''}
            ...
            <div className="px-4 py-3 dark:bg-white/5 bg-[#00165F]/5 rounded-xl border dark:border-white/10 border-[#00165F]/10 min-h-[80px]">
              <p className="dark:text-white/80 text-[#00165F]/80">{formData.bio || <span className="dark:text-white/40 text-[#00165F]/40">Aucune bio</span>}</p>
            </div>
          )}
        </div>
        ...
        {/* Discord */}
        <div className="group">
          <label className="block text-xs font-bold uppercase tracking-wider dark:text-white/40 text-[#00165F]/40 mb-2">Discord</label>
          {isDiscordConnected ? (
            ...
            >
              ...
              <span className="font-bold text-white">Connecter Discord</span>
            </button>
          )}
        </div>
        ...
        {/* Twitch */}
        <div className="group">
          <label className="block text-xs font-bold uppercase tracking-wider dark:text-white/40 text-[#00165F]/40 mb-2">Twitch</label>
          {isEditing ? (
            <input
              type="text"
            ...
            <div className="px-4 py-3 dark:bg-white/5 bg-[#00165F]/5 rounded-xl border dark:border-white/10 border-[#00165F]/10">
              <p className="dark:text-white text-[#00165F] font-semibold">{formData.twitchUsername || <span className="dark:text-white/40 text-[#00165F]/40">Non renseigné</span>}</p>
            </div>
          )}
        </div>
