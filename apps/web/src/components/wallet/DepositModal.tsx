...
export default function DepositModal({ onClose, onSuccess }: DepositModalProps) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 z-[100] flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-sm">
      <motion.div
        initial={{ scale: 0.9, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        exit={{ scale: 0.9, opacity: 0 }}
        className="w-full max-w-md dark:bg-[#00165F] bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh] my-auto"
      >
        {/* Header */}
